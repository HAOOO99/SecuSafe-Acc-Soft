"""
Django settings for productSys project.
...
SECRET_KEY = 'django-insecure-yqa4!(++4xdaw=79yj=(a@1!-=3qhr(r-x+()^#te^6ezh6qio'
...
WSGI_APPLICATION = 'productSys.wsgi.application'
ASGI_APPLICATION = 'productSys.asgi.application'
CHANNEL_LAYERS = {
    'default': {
