...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$870000$GUpT4k0gYphKL5SJ5douxF$ib1MzhZhyHoHh6mwLjRYEoXvzx8IXnWNl0gTT2PObnk=','2025-01-31 05:04:24.904685',1,'secusafe','','','yanhao@secusafe.com.au',1,1,'2025-01-15 22:09:20.000000'),(2,'pbkdf2_sha256$870000$zx6ZQJhq9trRstcKuF3am5$mY5j35P3YIxEAqaZuGjPZi64k283L0w9KeMH/tSmXnY=',NULL,0,'test','a','b','xuyanhao2000@outlook.com',0,1,'2025-01-15 22:12:48.000000');
...
INSERT INTO `brands_brand` VALUES (1,'AJAX'),(2,'Dahua'),(3,'UNV'),(4,'VIVOTEK');
...
INSERT INTO `credits_cn` VALUES (1,'2025-02-05','CRK','Email evidence XXXXXX',2000.00,'Cn123123',2000.00,'SSCN123123','Bank Transfer','AUD','USD','Compensation','AJAX'),(2,'2025-01-21','AJAX','Email evidence XXXXXX',100.00,'76543234567',200.00,'1211111','Pending','AUD','USD','Discount','AJAX'),(3,'2025-01-01','AJAX',' testtest',1999.00,'1234567890',200.00,'1234567890','Offset Statement',' AUD','USD','Compensation','AJAX'),(4,'2025-02-11','LocalA','123456789',200.00,NULL,NULL,NULL,NULL,'USD',NULL,'Compensation','AJAX'),(5,'2025-02-11','AJAX','qerwetrqw4er',300.00,'1345636',100.00,NULL,NULL,'AUD','AUD','Compensation','AJAX'),(6,'2025-02-06','AJAX','qwerty',200.00,'23456765432',100.00,NULL,NULL,'AUD','AUD','Compensation','AJAX'),(7,'2025-02-12','AJAX','asdfgfdsawert',100.00,'0000000',100.00,NULL,NULL,'USD','AUD','Compensation','AJAX'),(8,'2025-02-13','AJAX','email',1000.00,'123456',2000.00,'123577','Bank Transfer','AUD','AUD','Compensation','AJAX');
...
INSERT INTO `invoices_ci` VALUES ('AJAX','','','AJAX','2025-02-04',0.00,0.00,0.00,0,NULL),('AJAX','11223344','12345','AJAX','2025-02-04',200.00,0.00,10.00,0,NULL),('AJAX','123','123','AJAX','2025-02-04',0.00,0.00,0.00,0,NULL),('AJAX','PO-1111111','111111111','AJAX','2024-12-16',10000.00,0.00,0.00,0,NULL),('AJAX','PO-123123123','1234567890','AJAX','2025-02-02',10000.00,0.00,0.00,0,NULL),('AJAX','PO-22222222','22222222','AJAX','2025-01-23',0.00,200.00,0.00,0,NULL),('AJAX','PO-3333333','1234567890','AJAX','2025-02-03',0.00,1000.00,0.00,0,NULL);
...
INSERT INTO `products_pi` VALUES ('AJAX','AJAX','','2025-02-04',0.00,0.00,0.00,0,'','',0.00),('AJAX','LocalB','1','2025-01-01',0.00,20000.00,2000.00,1,'teststest','',0.00),('AJAX','AJAX','11111111111','2025-01-21',300.00,0.00,0.00,0,'123','www.github.com',0.00),('AJAX','QWE','111222333','2025-01-09',600.00,200.00,100.00,1,'qqqqq1q','www.github.com',0.00),('AJAX','LocalB','1123123141555','2025-01-31',0.00,2000.00,2000.00,1,'qweqqq','',0.00),('AJAX','AJAX','12312123132','2024-12-16',500.00,0.00,0.00,0,'','www.github.com',0.00),('AJAX','LocalA','123123123','2025-01-03',2000.00,0.00,0.00,0,'','',199.00),('AJAX','AJAX','12341231','2025-01-16',10.00,0.00,20.00,1,'','',10.00),('AJAX','AJAX','1234567','2025-01-01',1999.00,0.00,0.00,0,' ','',0.00),('AJAX','AJAX','22222222222','2025-01-21',2000.00,200.00,200.00,0,'poiuytrewqkjhgfdsvcx','www.github.com',100.00),('AJAX','AJAX','22222222222123','2025-02-12',80000.00,0.00,0.00,0,'','',0.00);
...
INSERT INTO `remittances_remittance` VALUES (1,'AJAX','2025-02-05',20000.00,'AUD','Bank Transfer',NULL),(2,'AJAX','2025-02-12',1000.00,'USD','Bank Transfer','CBA'),(3,'AJAX','2024-11-21',100.00,'AUD','Bank Transfer','CBA');
...
INSERT INTO `suppliers_supplier` VALUES (1,'AJAX','AJAX'),(2,'LocalA','AJAX'),(3,'LocalB','AJAX'),(4,'LocalA','Dahua'),(5,'Dahua','Dahua'),(6,'LocalC','AJAX');
...
CREATE TABLE `targets_target` (
  ...
  `company_name` varchar(100) NOT NULL,
  `year` int NOT NULL,
  `CI_targetA` int NOT NULL,
  `CI_targetB` int NOT NULL,
...
INSERT INTO `targets_target` VALUES (1,'AJAX',2025,80000,100000,81000,100000),(2,'Dahua',2025,1900,2000,1900,2000);
...
-- Dump completed on 2025-02-13 11:20:48
