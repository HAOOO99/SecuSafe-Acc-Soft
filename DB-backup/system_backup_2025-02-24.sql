...
INSERT INTO `credits_cn` VALUES (1,'2025-01-21','Ajax','Advanced payment, Email evidence from Yulia,17/1/2025,ETA check',50000.00,'no offical CN, only email confirmation',50019.00,NULL,'applied','USD','USD','rebate','AJAX'),(2,'2025-01-21','Ajax','Apol open day,lucky draw support,Email evidence from Yulia,17/1/2025,ETA check',0.00,'no offical CN, only email confirmation',697.00,NULL,NULL,'USD','USD','Marketing','AJAX'),(3,'2025-01-21','Ajax','Secusafe special event, expense claim,Email evidence from Yulia,17/1/2025,ETA check',0.00,'no offical CN, only email confirmation',4201.13,NULL,'appiled','USD','USD','Compensation','AJAX'),(4,'2025-02-11','UNV','5% rebate for energy efficient #155244&#156066,EQL & Digitronic',1000.00,NULL,NULL,NULL,NULL,'USD','AUD','Compensation','UNV'),(5,'2025-02-24','AJAX','',100.00,NULL,NULL,NULL,NULL,'USD','AUD','Marketing','AJAX');
...
-- Dump completed on 2025-02-24 16:30:05
